...
from training.serializers import TrainingListSerializer, BaseTrainingSerializer, BaseProblemSetSerializer, \
    LearningPlanListSerializer, BaseLearningPlanSerializer
...
class LearningPlanListCreateView(generics.ListCreateAPIView):
    ...
    def get_serializer_class(self):
        ...
        return BaseLearningPlanSerializer
